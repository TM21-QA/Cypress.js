describe('Покупка аватара', function () {                                // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('.credit').type('4960148141713419');                     // вводим номер карты
         cy.get('.k_input_ccv').type('125');                             // вводим CVV карты
         cy.get('.k_input_date').type('1130');                           // вводим срок действия карты
 ...
 // запуск через теринал: npx cypress run --spec cypress/e2e/Buy_an_avatar.cy.js --browser electron